...
function Tab2_TableHook(props: any) {
    ...
    const editFieldStatusHandler = (id: number, companyId:number) => {
        props.editRecordHandler(id, companyId)
    };
    ...
    const changeStatus = (id: number) => {
        ...
        setConfirmationType("sendToRegisteration")
    };
    
    const disApprove = (id: number) => {
        setVisibleConfirmModal(true)
        setConfirmationType("disapprove")
    };
