...
const GetColumnSearchProps = (titles: any[]) => {
    ...
    const onFinish = (values: any) => {
        ...
        if (values?.filters != undefined && values?.filters.length > 0) {
            ...
            globalContext.onResubmitFilter(true);
            globalContext.onSetSubmittedFilters(filtersWithOperand);
            globalContext.onSetIsAdvancedSearch(true);
            globalContext.searchAgain();
            globalContext.onChangeActiveCollapsiblePanel();
        }
    ...
    const removeAllFilters = () => {
        ...
        globalContext.onResubmitFilter(true);
        globalContext.searchAgain();
        globalContext.onSetIsAdvancedSearch(false);
        globalContext.onChangeActiveCollapsiblePanel();
    }
